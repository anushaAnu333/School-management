      ...
      <div className="grid grid-cols-2 gap-3">
        {buttons.map((button, index) => (
          <button
            ...
            className="border-2 border-green-200 text-green-600 bg-white rounded-lg p-3 flex flex-col items-center justify-center space-y-1 hover:bg-green-50 hover:border-green-300 hover:shadow-lg transform hover:scale-105 transition-all duration-300 group cursor-pointer"
