...
Step 1 : Install App / Open Website
Step: 2 , Register 
	School/ College Name
...
Step 3: Generate OTP & Validate 
Step 4 :Message to Mobile & Mail id 
Temporary Login details: 
Username: Mail id 
		Password : 5 letter of mail id &1234 or Random

 After login 
Step 1 : Set up your Organisation
Needs to make it uniform for School/Junior College/Degree College
Setup School/College Details 
Type of Institue: Scholl/ Jr College/ Degree College
School Name
Address
Contact Details 
Mobile 1: +91 
...
Mail Id 1 :
Mail Id 2
PAN Number : Format (AAAAA1111A) (10 DIGIT (5 alabhabets 4 Numberic 1 Albhabet)
TAN Number: Format (AAAA11111A)   (10 DIGIT (4 alabhabets 5 Numberic 1 Albhabet)
Society Registration Number
Date of Establishment
Last Renewed date:
Next Renewal date: 

Board : CBSC/ ICSE/State Board/ Others (School can choose more than 1 option)
Status : Autonomus/ Affliated/others


School Strength (Maximum): Number

Classes/ Branches Available: needs to enter manually(once)
(In case of Branches :Need to Enter Sub Branches Details ) 
Nursery
...
Class wise Strength ( Need to set validate for maximum number of students in class/Branch/Sub Branch)


CBSE/ICSE/State (1st selection from Board
CBSE/ICSE/State (2nd  selection from Board
CBSE/ICSE/State (3rd  selection from Board
Nursuery
...
Fee Master Configuration for Acadamic Year 2024-25
...
Once They select others ( One more drop should come , Others(Specify)



(Fees Needs to be set up for every class)
